  ...
  <div className="h-screen bg-gray-100 pt-20">
    ...
    <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      {cart.map((item)=>(
             ...
             <img src="hghgfhfgh" alt="product-image" className="w-full rounded-lg sm:w-40" />
             <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
               <div className="mt-5 sm:mt-0">
                 <h2 className="text-lg font-bold text-gray-900">{item.card.info.name}</h2>
                 <p className="mt-1 text-xs text-gray-700">{item.card.info.category}</p>
               </div>
               <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                 ...
                 <div className="flex items-center space-x-4">
                   <p className="text-sm">{cart.card.info.price}</p>
